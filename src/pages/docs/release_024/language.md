...
To see the args for a particular function, you can use [verbose listing mode](cli#listing-probes).
Example:
```
...
For bpftrace PERCPU map types (e.g., those created by using [`count()`](stdlib#count) or [`sum()`](stdlib#sum)) you may coerce
